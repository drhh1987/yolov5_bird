...
from UI_rec.BirdRecing import Bird_MainWindow


class LoginForm(QWidget):
    def __init__(self):
        super().__init__()
        self.text = "鸟类识别系统用户登录注册"
        ...
        self.bird_main = self.Bird_Main()

    class Bird_Main(Bird_MainWindow):
        pass
    ...
    def initUI(self):
        ...
        self.setWindowIcon(QIcon('icons/logo-ini.png'))
        ...
        # 添加左侧logo
        logolb = QLabel(self)
        logopix = QPixmap("icons/bird.png")
